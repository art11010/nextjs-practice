      ...
      <main className="px-6">
        ...
        <section>
          ...
          <div className="mt-5 grid grid-cols-2">
            <div className="py-2 text-center text-xs text-black  font-bold bg-neutral-200 rounded-tl-md">
              정류장명
            </div>
            <div className="py-2 text-center text-xs text-black  font-bold bg-neutral-200 rounded-tr-md">
              버스 번호
            </div>

            <div className="py-3 px-2 text-xs border-b border-neutral-600">
